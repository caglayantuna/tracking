...
# ========== CONFIG ==========
VIDEO_DIR = os.path.expanduser("~/frames_black")
LABELED_MASK_PATH = os.path.expanduser("~/labeled_mask_black.png")
CHECKPOINT = os.path.expanduser("~/sam2_checkpoints/sam2_hiera_large.pt")
MODEL_CFG = "sam2_hiera_l.yaml"
OUTPUT_DIR = os.path.expanduser("~/output_full_black_large_model")
TEMP_DIR = os.path.expanduser("~/temp_chunk")
...
print(f"\n🎉 DONE!")
print(f"  Video: {OUTPUT_DIR}/tracked_result.mp4")