...
CHECKPOINT   = os.path.expanduser("/pasteur/helix/users/ctuna/pretrained_models/sam2_hiera_small.pt")
...
def extract_frames(video_path: str, frames_dir: str) -> list[str]:
    ...
    while True:
        ...
        # JPEG is ~3× faster than PNG and plenty for SAM2 inputs
        cv2.imwrite(
...
def run_chunk(
    ...
    """
    Run SAM-2 propagation over one chunk of frames.
...
def main(video_path: str):
    ...
    OUTPUT_DIR  = os.path.expanduser(f"./output_yolo_sam_2/{video_stem}/")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Track larvae in video and export outline/spine files."
    )
